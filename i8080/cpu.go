...
var OpcodeTable []Opcode = []Opcode{
	/* 00 00000000 */ {1, "NOP"},
	/* 01 00000001 */ {3, "LXI BC,nn"},
	/* 02 00000010 */ {1, "STAX BC"},
	/* 03 00000011 */ {1, "INX BC"},
	/* 04 00000100 */ {1, "INR B"},
	/* 05 00000101 */ {1, "DCR B"},
	/* 06 00000110 */ {2, "MVI B,n"},
	/* 07 00000111 */ {1, "RLC"},
	/* 08 00001000 */ {1, "-"},
	/* 09 00001001 */ {1, "DAD BC"},
	/* 0A 00001010 */ {1, "LDAX BC"},
	/* 0B 00001011 */ {1, "DCX BC"},
	/* 0C 00001100 */ {1, "INR C"},
	/* 0D 00001101 */ {1, "DCR C"},
	/* 0E 00001110 */ {2, "MVI C,n"},
	/* 0F 00001111 */ {1, "RRC"},
	/* 10 00010000 */ {1, "-"},
	/* 11 00010001 */ {3, "LXI DE,nn"},
	/* 12 00010010 */ {1, "STAX DE"},
	/* 13 00010011 */ {1, "INX DE"},
	/* 14 00010100 */ {1, "INR D"},
	/* 15 00010101 */ {1, "DCR D"},
	/* 16 00010110 */ {2, "MVI D,n"},
	/* 17 00010111 */ {1, "RAL"},
	/* 18 00011000 */ {1, "-"},
	/* 19 00011001 */ {1, "DAD DE"},
	/* 1A 00011010 */ {1, "LDAX DE"},
	/* 1B 00011011 */ {1, "DCX DE"},
	/* 1C 00011100 */ {1, "INR E"},
	/* 1D 00011101 */ {1, "DCR E"},
	/* 1E 00011110 */ {2, "MVI E,n"},
	/* 1F 00011111 */ {1, "RAR"},
	/* 20 00100000 */ {1, "-"},
	/* 21 00100001 */ {3, "LXI HL,nn"},
	/* 22 00100010 */ {1, "STAX HL"},
	/* 23 00100011 */ {1, "INX HL"},
	/* 24 00100100 */ {1, "INR H"},
	/* 25 00100101 */ {1, "DCR H"},
	/* 26 00100110 */ {2, "MVI H,n"},
	/* 27 00100111 */ {1, "DAA"},
	/* 28 00101000 */ {1, "-"},
	/* 29 00101001 */ {1, "DAD HL"},
	/* 2A 00101010 */ {1, "LDAX HL"},
	/* 2B 00101011 */ {1, "DCX HL"},
	/* 2C 00101100 */ {1, "INR L"},
	/* 2D 00101101 */ {1, "DCR L"},
	...
	/* CF 11001111 */ {1, "RST 1"},
	/* D0 11010000 */ {1, "RNC"},
	/* D1 11010001 */ {1, "POP DE"},
	/* D2 11010010 */ {3, "JNC nn"},
	/* D3 11010011 */ {2, "OUT n"},
	/* D4 11010100 */ {3, "CNC nn"},
	/* D5 11010101 */ {1, "PUSH DE"},
	/* D6 11010110 */ {2, "SUI n"},
	/* D7 11010111 */ {1, "RST 2"},
	/* D8 11011000 */ {1, "RC"},
	/* D9 11011001 */ {1, "-"},
	...
	/* DF 11011111 */ {1, "RST 3"},
	/* E0 11100000 */ {1, "RPO"},
	/* E1 11100001 */ {1, "POP HL"},
	/* E2 11100010 */ {3, "JPO nn"},
	/* E3 11100011 */ {1, "XTHL"},
	/* E4 11100100 */ {3, "CPO nn"},
	/* E5 11100101 */ {1, "PUSH HL"},
	/* E6 11100110 */ {2, "ANI n"},
	/* E7 11100111 */ {1, "RST 4"},
	/* E8 11101000 */ {1, "RPE"},
	/* E9 11101001 */ {1, "PCHL"},
